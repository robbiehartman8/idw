--------------------------------------------------------------------
----- CREATE HR_EMPLOYEE_TMP-STG-AUD-INS-UPD -----
--------------------------------------------------------------------
...
CREATE TABLE [IDW].[HR_EMPLOYEE_TMP] (
...
CREATE TABLE [IDW].[HR_EMPLOYEE_AUD] (
...
CREATE OR ALTER TRIGGER [IDW].[HR_EMPLOYEE_INS] ON [IDW].[HR_EMPLOYEE_STG]
AFTER INSERT
AS
    BEGIN
        INSERT INTO [IDW].[HR_EMPLOYEE_AUD]
        SELECT 'INSERT', * 
        FROM INSERTED
    END
GO

CREATE OR ALTER TRIGGER [IDW].[HR_EMPLOYEE_UPD] ON [IDW].[HR_EMPLOYEE_STG]
AFTER UPDATE
AS
    BEGIN
        INSERT INTO [IDW].[HR_EMPLOYEE_AUD]
