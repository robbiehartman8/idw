...
TRUNCATE TABLE [IDW].[IDW_UID_STG]
TRUNCATE TABLE [IDW].[IDW_EMAIL_STG]
...
DROP TABLE [IDW].[IDW_UID_STG]
DROP TABLE [IDW].[IDW_EMAIL_STG]
...
DROP PROCEDURE [IDW].[IDW_UID_EMAIL_SP]
...
DROP VIEW [IDW].[GET_NEW_ID] 

--------------------------------------------------------------------
----- DROP FUNCTIONS -----
--------------------------------------------------------------------

DROP FUNCTION [IDW].[GENERATE_UID]
DROP FUNCTION [IDW].[GENERATE_EMAIL]