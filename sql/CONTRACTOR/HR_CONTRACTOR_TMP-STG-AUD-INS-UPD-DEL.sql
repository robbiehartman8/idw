...
CREATE OR ALTER TRIGGER [IDW].[HR_CONTRACTOR_INS] ON [IDW].[HR_CONTRACTOR_STG]
AFTER INSERT
AS
    INSERT INTO [IDW].[HR_CONTRACTOR_AUD]
    SELECT 'INSERT', * 
    FROM INSERTED
GO

CREATE OR ALTER TRIGGER [IDW].[HR_CONTRACTOR_UPD] ON [IDW].[HR_CONTRACTOR_STG]
AFTER UPDATE
AS
    INSERT INTO [IDW].[HR_CONTRACTOR_AUD]
    SELECT 'UPDATE', * 
