...
REGISTRY_NAME=usedadvcrdacr05.azurecr.io
SOURCE_REGISTRY=k8s.gcr.io
CONTROLLER_IMAGE=ingress-nginx/controller
CONTROLLER_TAG=v1.0.4
PATCH_IMAGE=ingress-nginx/kube-webhook-certgen
...
CERT_MANAGER_IMAGE_WEBHOOK=jetstack/cert-manager-webhook
CERT_MANAGER_IMAGE_CAINJECTOR=jetstack/cert-manager-cainjector
ACR_URL=usedadvcrdacr05.azurecr.io
DNS_LABEL=thd-iam-idw-apis
RG_NAME=MC_USEDADVCRDRSG14_USEDADVCRDAKS01_eastus
...
az aks update -n USEDADVCRDAKS01 -g USEDADVCRDRSG14 --attach-acr USEDADVCRDACR05